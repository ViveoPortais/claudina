...
export default function HomeLayout({ children }: HomeLayoutProps) {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden">
      <nav className="bg-white border-gray-200 w-full shadow-xl border">
      ...
      {program === "Programa" ? (
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-center sm:col-span-2 sm:justify-end mb-28">
              <ScrollArea
                className={`bg-white border border-gray-200 rounded-xl flex flex-col items-center justify-center p-4 md:p-8 mx-4 max-h-[90vh] md:max-h-[80vh] sm:w-[90%] lg:w-[500px] xl:w-[480px] 2xl:w-[550px] ${
