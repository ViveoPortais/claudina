    ...
    <div className="p-2">
      ...
      <div className="grid grid-cols-1 md:grid md:grid-cols-2 gap-5 my-5">
        <ContentCard
          ...
          buttonText="Ver Mais"
          onButtonClick={() =>
            router.push("/dashboard/oncoclinica/pre-register")
          }
        />
        <ContentCard
          ...
          bgColor="bg-main-blue"
          buttonText="Ver Mais"
          onButtonClick={() => router.push("/dashboard/oncoclinica/exam")}
        />
        <ContentCard
          ...
          buttonText="Ver Mais"
          onButtonClick={() =>
            router.push("/dashboard/oncoclinica/solicitation")
          }
        />
        <ContentCard
          ...
          buttonText="Ver Mais"
          onButtonClick={() =>
            router.push("/dashboard/oncoclinica/inativation")
          }
        />
      </div>
      <Dialog
