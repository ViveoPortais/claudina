export function Footer() {
  return (
    <section className="flex h-[8%] md:h-[5%] flex-col gap-1 md:gap-0 md:flex-row items-center justify-center md:justify-between px-2 md:px-8 py-2 md:py-4 text-xs bg-gray-200 text-gray-800">
