  ...
  return (
    <>
      <div className="flex flex-col gap-5">
        <h1 className="text-center font-bold">REGULAMENTO</h1>
        <p className="text-center underline text-sm">PROGRAMA CLAUDINOVA</p>
        <p className="text-sm">
          O presente regulamento estabelece asregras e diretrizes para
          participação e adesão de pacientes com diagnóstico de câncer gástrico
          ou de junção gastroesofágica localmente avançado inoperável ou
          metastático (“Pacientes”) no Programa de Diagnóstico Claudinova
          (“Programa”), que tem por objetivo principal fornecer acesso ao teste
          do biomarcador Claudina 18.2.
        </p>
        <p className="text-sm">
          O Programa é desenvolvido e financiado pela ASTELLAS FARMA BRASIL
          IMPORTAÇÃO E DISTRIBUIÇÃO DE MEDICAMENTOS LTDA., estabelecida na Av.
          das Nações Unidas, 14.171, Torre C, 25º andar, conjuntos 2501, 2503 e
        ...
        <p className="text-sm">
          ...
          <a
            ...
            target="_blank"
          >
            https://www.viveo.com.br/politica-de-privacidade/.
          </a>
          .
        </p>
        <p className="text-sm">
        ...
        <p className="text-sm">
          ...
          biológico (“Amostra”) previamente coletadas pelo médico:
        </p>
        <p className="text-sm">
        ...
        <p className="text-sm underline">
          ...
          Profissionais e o devido aceite do Termo de Consentimento Livre e
          Esclarecido do Paciente constituem a aceitação integral,
          respectivamente, pelo Profissional Médico/Profissional de Saúde e pelo
          Paciente, dos termos e condições deste Regulamento.
        </p>
      </div>
      <div className="flex flex-col gap-5 mt-5">
        ...
        <p className="text-sm">
          (b) O Paciente deverá apresentar resultado negativo para o teste HER2,
          caso já tenha realizado esse teste. Pacientes sem acesso ao HER2
          poderão ter o teste realizado pelo Programa;
        </p>
        <p className="text-sm">
          (c) O Paciente deverá possuir idade igual ou superior a 18 (dezoito)
          anos;
        </p>
        <p className="text-sm">
        ...
        <p className="text-sm">
          1.3. A participação do Profissional de Saúde no Programa está
          condicionada ao atendimento das seguintes condições:
        </p>
        <p className="text-sm">
          (a) Ele deverá estar devidamente inscrito junto ao respectivo Conselho
          Profissional de sua prática profissional;
        </p>
        <p className="text-sm">
          (b) Deverá ter realizado o seu cadastro no site do Programa;
        </p>
        <p className="text-sm">
          (c) Deverá ter seu cadastro para acesso à Área do Médico responsável
          devidamente aprovado pelo Médico; e
        </p>
        <p className="text-sm">
          (d) O cadastro de Profissional de Saúde deverá sempre estar vinculado
          ao cadastro de um Profissional Médico previamente cadastrado no
          Programa.
        </p>
        <p className="text-sm">
          A participação no Programa está sujeita ainda à aceitação e
          concordância com os termos e condições da Política de Privacidade
          previstos no link (www.programaclaudinova.com.br\) pelo Profissional
          Médico e Profissional de Saúde.
        </p>
        <p className="text-sm">
      ...
      <div className="flex flex-col gap-5 mt-5">
        <p className="text-sm">2. Dinâmica e Etapas do Programas</p>
        <p className="text-sm">
          2.1. O Programa será composto por cinco (5) etapas, sendo a primeira
          referente ao cadastro indicado nas cláusulas 1.2 e 1.3 acima. As
          demais seguem descritas nesta seção.
        </p>
        ...
        <p className="text-sm">
          ...
          da amostra no endereço informado no momento da solicitação;
        </p>
        <p className="text-sm">
          (b) O parceiro logístico transportará a amostra ao laboratório
          escolhido para realização do(s) teste(s);
        </p>
        <p className="text-sm">
          (c) A retirada da amostra pelo parceiro logístico ficará sujeita à
        ...
        <p className="text-sm">
          ...
          pelo Profissional Médico no momento da solicitação para informar sobre
          a liberação do resultado que ficará disponível na plataforma do
          Programa; e
        </p>
        <p className="text-sm">
          (c) Após o prazo referido em (a) acima, os resultados dos testes serão
          excluídos do Site. Neste caso, o Profissional Médico poderá contatar o
          Programa ou poderá contatar diretamente o laboratório para obtenção de
      ...
      <div className="flex flex-col gap-5 mt-5">
        <p className="text-sm">3. Prazo, Cancelamento e Exclusão do Programa</p>
        <p className="text-sm">
          3.1. O Programa vigerá por prazo indeterminado e poderá ser alterado,
          suspenso, interrompido ou encerrado, a qualquer momento, pela
          Astellas, mediante comunicação realizada no Site ou mediante
          comunicação realizada pela Central de Atendimento através de telefone,
          SMS, e-mail ou notificação enviada ao endereço dos Profissionais
          cadastrados.
        </p>
        <p className="text-sm">
          3.2. O Profissional Médico, Profissional de Saúde ou Paciente poderão
          ter sua participação cancelada no Programa nas seguintes hipóteses:
        </p>
        <p className="text-sm">
          (a) Dificuldade ou impossibilidade no contato com o Profissional
          Médico, o que ocorrerá, após ao menos 30 (trinta) dias de tentativas
          de contato em dias e horários alternados, desde que não tenha nenhuma
        ...
        <p className="text-sm">
          3.4. Na hipótese do Profissional Médico solicitar seu
          descadastramento, a Central de Atendimento do Programa verificará se
        ...
        <p className="text-sm">
          ...
          revogado o consentimento para tratamento de dados se tais dados forem
          necessários, e na exata medida em que o forem, para (i) cumprimento de
          obrigações legais e regulatórias relativas ao Programa; ou para (ii)
          exercício regular de direito, em contrato ou processo, especialmente
          para garantir que as disposições deste Regulamento sejam cumpridas e
          não haja abuso do Programa por parte do Paciente.
        </p>
        <p className="text-sm">
          3.5.1. Alternativamente à exclusão dos dados pessoais, a Parceira
          poderá, ficando desde já autorizada pelo Paciente, proceder à
          anonimização dos dados pessoais do Paciente em questão, de modo a
          integrar os dados anonimizados em bancos de dados estatísticos,
          garantida a impossibilidade de re-identificação dos dados pessoais
          considerando os critérios exigidos pela Lei.
        </p>
      </div>
      <div className="flex flex-col gap-5 mt-5">
        <p className="text-sm underline">4. Gestora dos Dados</p>
        <p className="text-sm">
      ...
      <div className="flex flex-col gap-5 mt-5">
        ...
        <p className="text-sm">
          ...
          participar no Programa, possuindo todas as autorizações necessárias
          para executar as atividades aqui descritas;
        </p>
        <p className="text-sm">
          (b) Inexiste qualquer conflito de interesse para participação no
          Programa;
        </p>
        <p className="text-sm">
      ...
      <div className="flex flex-col gap-5 mt-5">
        <p className="text-sm">7. Das Disposições Gerais</p>
        <p className="text-sm">
        ...
        <p className="text-sm">
          ...
          neste Regulamento poderá ser interpretado de forma a constituir uma
          sociedade, ou qualquer outro tipo de associação, formal ou informal
          com a Astellas.
        </p>
        <p className="text-sm">
          7.3. A nulidade de qualquer cláusula ou condição deste Regulamento não
          afetará a validade ou a execução de suas demais cláusulas e condições.
          Caso qualquer uma das cláusulas ou condições do presente Regulamento
          seja considerada nula, inválida ou inexequível, as Partes se
          comprometem a negociar de boa-fé a substituição de referida cláusula
          ou condição por uma cláusula ou condição equivalente, que seja válida,
          eficaz e exequível.
        </p>
        <p className="text-sm">
          7.4. Toda comunicação relativa ao Programa poderá ser encaminhada aos
          cuidados da Central de Atendimento, através dos canais disponíveis
          indicados na cláusula 6.
        </p>
        <p className="text-sm">
          7.5. Fica eleito o foro da comarca de São Paulo, Estado de São Paulo,
          para a resolução de disputas relacionadas ao Programa,
          independentemente de sua natureza, com exclusão de qualquer outro, por
      ...
      <div className="flex flex-col gap-5 mt-5">
        ...
        <p className="text-sm">
          Para participar do Programa, o participante deverá concordar com os
          termos do Regulamento, Aviso de Privacidade e Termo de Consentimento
